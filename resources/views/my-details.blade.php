...
<?php
// get coumtries and languages frm helper
...
@csrf
                ...
                <div class="columns is-multiline">
                  ...
                  <div class="column is-3">
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <input class="input" type="text"  id="streetName" name="streetName" >
                      </div>
                    </div>
                  </div>
                ...
                <div class="columns is-multiline">
                  ...
                  <div class="column is-3">
                    <div class="field">
                      ...
                      <div class="control">
                        <div class="select">
                          <select name="sstate" id="sstate" class="sstate"> 
                            <option value="">Select one</option>
                            <option  value="VIC">VIC</option>
                            <option  value="NSW">NSW</option>
                            <option  value="QLD">QLD</option>
          ...
          <!--End Info Section -->
<?php /*?><input type="hidden" id="contactID" value="<?php echo $user->CONTACTID; ?>"name="contactID"> <?php */?>
          
          <input type="hidden" id="contactID" value="4772088" name="contactID">
...
var spostcode = $('#spostcode').val();
            if(streetNo == "") {
                 $("#streetNo").closest('.input').addClass('is-danger');
                $("#streetNo").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#streetNo").closest('.input').removeClass('is-danger');
                 $("#streetNo").closest('.is-success').addClass('has-success');
                 
            } 
            if(streetName == "") {
                 $("#streetName").closest('.input').addClass('is-danger');
                $("#streetName").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#streetName").closest('.input').removeClass('is-danger');
                 $("#streetName").closest('.is-success').addClass('has-success');
                 
            } 
            if(city == "") {
                 $("#city").closest('.input').addClass('is-danger');
                $("#city").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#city").closest('.input').removeClass('is-danger');
                 $("#city").closest('.is-success').addClass('has-success');
                 
            } 
            if(state == "") {
                 $("#state").closest('.state').addClass('is-danger');
                $("#state").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#state").closest('.state').removeClass('is-danger');
                 $("#state").closest('.is-success').addClass('has-success');
                 
            }
            if(postcode == "") {
                 $("#postcode").closest('.input').addClass('is-danger');
                $("#postcode").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#postcode").closest('.input').removeClass('is-danger');
                 $("#postcode").closest('.is-success').addClass('has-success');
                 
            }   
            if(sstreetNo == "") {
                 $("#sstreetNo").closest('.input').addClass('is-danger');
                $("#sstreetNo").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#sstreetNo").closest('.input').removeClass('is-danger');
                 $("#sstreetNo").closest('.is-success').addClass('has-success');
                 
            } 
            if(sstreetName == "") {
                 $("#sstreetName").closest('.input').addClass('is-danger');
                $("#sstreetName").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#sstreetName").closest('.input').removeClass('is-danger');
                 $("#sstreetName").closest('.is-success').addClass('has-success');
                 
            }   
            if(scity == "") {
                 $("#scity").closest('.input').addClass('is-danger');
                $("#scity").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#scity").closest('.input').removeClass('is-danger');
                 $("#scity").closest('.is-success').addClass('has-success');
                 
            } 
            if(sstate == "") {
                 $("#sstate").closest('.sstate').addClass('is-danger');
                $("#sstate").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#sstate").closest('.sstate').removeClass('is-danger');
                 $("#sstate").closest('.is-success').addClass('has-success');
                 
            }
            if(spostcode == "") {
                 $("#spostcode").closest('.input').addClass('is-danger');
                $("#spostcode").after('<p class="txt-support-red">The field is required</p>');
                
            } else {
                $("#spostcode").closest('.input').removeClass('is-danger');
                 $("#spostcode").closest('.is-success').addClass('has-success');
                 
            } 
// Validation end  
alert(sstreetNo);
if(streetNo,streetName ,city ,state, postcode,sstreetNo ,sstreetName ,scity, sstate, spostcode){
                ...
                success: function(data) {
                    ...
                    if(data.status == 'success'){
                        ...
                        $('.response').hide().html('<p class="submit"> ' + data.message + '</p>').fadeIn();
                    } else {
                        $('.response').hide().html('<p class="error"> ' + data.message + '</p>').fadeIn();
                    }
                },
                error: function(data) {
